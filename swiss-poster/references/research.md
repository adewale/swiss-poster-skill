...
- **Max Miedinger** (1910–1980) — Designed Neue Haas Grotesk (1957), later renamed Helvetica (1960), with Eduard Hoffmann at the Haas Type Foundry in Munchenbuchsee. The typeface that defined the International Style.
- **Adrian Frutiger** (1928–2015) — Designed Univers (1957), favored by the Basel school. Created a systematic numbering system for type weights and widths.

### The Escape (Basel School → New Wave, 1960s–80s)
...
| Work | Designer | Year | Significance |
| ---- | -------- | ---- | ------------ |
...
- Swiss Style: Principles, Typefaces & Designers — https://www.printmag.com/featured/swiss-style-principles-typefaces-designers/
...
- Niklaus Troxler — https://en.wikipedia.org/wiki/Niklaus_Troxler
- Siegfried Odermatt — https://en.wikipedia.org/wiki/Siegfried_Odermatt
- Max Bill — https://en.wikipedia.org/wiki/Max_Bill
- Herbert Matter — https://en.wikipedia.org/wiki/Herbert_Matter
- Adrian Frutiger — https://en.wikipedia.org/wiki/Adrian_Frutiger
- Max Miedinger — https://en.wikipedia.org/wiki/Max_Miedinger
- *Neue Grafik* — https://en.wikipedia.org/wiki/Neue_Grafik
...
## What distinguishes Swiss Poster from Swiss International Style

| Aspect | International Style | Poster Style |
| ------ | ------------------- | ------------ |
| Grid | Law. Every element obeys. | Launchpad. Key elements deliberately escape. |
| Type weight | Light/normal only. Never bold. | Full range: thin (100) through bold (700). Weight contrast is a primary tool. |
| Type scale | Moderate ratios (3-4x). | Extreme ratios (10x+). A single word can fill the viewport. |
| Accent usage | Sparingly. 10-15% of surface. | Boldly. 30-40% of surface. Full-width bands, large shapes. |
| Accent on type | Never. Headings are always stone/neutral. | Yes. Display-scale type in accent color is a compositional element. |
...
| Composition | Resolved. Settled. Balanced. | Unresolved. Tense. Asymmetric. Dynamic. |
